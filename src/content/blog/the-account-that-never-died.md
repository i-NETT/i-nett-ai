---
title: 'The Account That Never Died: Two Kinds of IT Risk'
description: 'Some technology risks cost nothing to fix. Others require planning and investment. Learn how leaders can identify and manage both.'
datePublished: 2026-08-23
author: 'Nick Dreyfus'
authorTitle: 'Vice President of Business Development, i-NETT'
source: 'The Digital Dilemma'
image: '/images/blog/orphan-account-hero.webp'
---
...
<figure class="post-fig right">
  <img src="/images/blog/orphan-account-offboarding.webp" alt="A security professional deactivating a former employee across company systems" width="1536" height="1024" loading="lazy" />
  <figcaption>Offboarding is complete only when every access path is verified closed.</figcaption>
</figure>
...
<figure class="post-fig left">
  <img src="/images/blog/orphan-account-decisions.webp" alt="Executives separating immediate IT controls from planned infrastructure investments" width="1536" height="1024" loading="lazy" />
  <figcaption>Separate quick control failures from projects that require investment.</figcaption>
</figure>
...
If these questions expose uncertainty, start with a [Fortify AI risk and readiness assessment](/contact). The goal is not to create fear. It is to distinguish a free fix from a funded project before a preventable incident makes that decision for you.

*Adapted from [The Digital Dilemma newsletter](https://thedigitaldilemma.riverside.com/p/the-account-that-never-died-and-the-two-kinds-of-it-problems-22).*
